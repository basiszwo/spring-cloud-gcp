...
https://docs.spring.io/spring/docs/current/spring-framework-reference/html/jdbc.html[Spring JDBC] so you can run your MySQL, PostgreSQL or SQL Server databases in https://cloud.google.com/sql[Google Cloud SQL] using Spring JDBC, or other libraries that depend on it like Spring Data JPA.

The Cloud SQL support is provided by Spring Cloud GCP in the form of three Spring Boot starters, one for MySQL, PostgreSQL and SQL Server.
...
<dependency>
    <groupId>org.springframework.cloud</groupId>
    <artifactId>spring-cloud-gcp-starter-sql-sqlserver</artifactId>
</dependency>
----
...
dependencies {
    ...
    implementation("org.springframework.cloud:spring-cloud-gcp-starter-sql-sqlserver")
}
----
